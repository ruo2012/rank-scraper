...
var URL = 'http://%ssearch.yahoo.com/search?ln=%s&p=%s&b=%d&n=%d&ie=UTF-8&oe=UTF-8';
...
var iyahoo = function(query, sedb, lang, start, proxy, links, index, callback) {
        ...
        request(requestOptions, function(err, resp, body) {
            if ((err == null) && resp.statusCode === 200) {
                ...
                if (links.length < yahoo.totalResults && index < 5) {
                    ...
                    index++;
                    iyahoo(query, sedb, lang, start + yahoo.resultsPerPage + 1, proxy, links, index, callback)
                } else {
