...
var URL = 'http://www.bing.com/search?setLang=%s&q=%s&cc=%s&first=%d&count=%d&ie=UTF-8&oe=UTF-8';
...
var ibing = function(query, sedb, lang, start, proxy, links, index, callback) {
        ...
        request(requestOptions, function(err, resp, body) {
            if ((err == null) && resp.statusCode === 200) {
                ...
                if (links.length < bing.totalResults && index < 3) {
                    ...
                    index++;
                    ibing(query, sedb, lang, start + bing.resultsPerPage + 1, proxy, links, index, callback)
                } else {
